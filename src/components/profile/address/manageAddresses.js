        ...
        <div>
            {
                userAddresses.length > 0 ?
                    userAddresses.sort((a, b) => {
                        ...
                        return <div className="border-bottom p-2 d-flex flex-row justify-content-between"  key={address._id}>
                            <div>
            ...
            <div className="p-2">    
                <div className="btn-link pointer" onClick={() => { setAddressEntryFormFlag(true) }}>Add New Address</div>
            </div>
            {
                showAddressEntryForm ?
                <AddressEntryForm
