...
export const DisplayHealthcareProviderAppoiintments = ({ userInfo = {} }) => {
    ...
    useEffect(() => {
        Promise.all([$.getJSON('/appointments/get/currentuser'), handlers.getUserPractices(userInfo._id)]).then(values => {
